%
% messrauschen_geaendert.tex -- Kombination der Messrauschen-Bilder
%
...
\node at (0,0) {\includegraphics[width=14cm]{../Messrauschen_geaendert.PNG}};
...
\node at (0,0) {\includegraphics[width=14cm]{../Messrauschen_geaendert_zoom.PNG}};
\end{scope}
...
\draw[line width=0.7pt] (\Links,\unten) rectangle (\Rechts,4.15);
